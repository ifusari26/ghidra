...
//					break;
    ...
    public DataTypeManagerService getDataTypeManagerService() {
        ...
        if (tool != null) {
            Optional<DataTypeManagerService> dtmService = tool.getService(DataTypeManagerService.class);
            if (dtmService.isPresent()) {
                return dtmService.get();
            }
        }
    ...
    public static synchronized AutoAnalysisManager getAnalysisManager(final Program program) {
