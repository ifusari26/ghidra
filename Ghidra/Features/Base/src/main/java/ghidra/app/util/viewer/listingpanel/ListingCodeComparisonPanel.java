...
public class ListingCodeComparisonPanel
    ...
    class ListingCodeComparisonOptionsAction extends DockingAction {
        ...
        @Override
        public void actionPerformed(ActionContext context) {
            tool.getService(OptionsService.class)
                    .ifPresent(
							(service) -> service.showOptionsDialog(
									ListingCodeComparisonOptions.OPTIONS_CATEGORY_NAME,
    ...
    private class DualListingMarkerManager extends MarkerManager {
        ...
        public GoToService getGoToService() {
            return serviceProvider.getService(GoToService.class).orElse(null);
        }
    }
    ...
    GoToService getGoToService(boolean isLeftSide) {
        return dualListingServiceProviders[isLeftSide ? LEFT : RIGHT].getService(GoToService.class).orElse(null);
    }
